...
module Verizon
  ...
  class Oauth2 < CoreLibrary::HeaderAuth
    ...
    def initialize(oauth_2credentials, config)
      auth_params = {}
      @_oauth_client_id = oauth_2credentials.oauth_client_id unless
        oauth_2credentials.nil? || oauth_2credentials.oauth_client_id.nil?
      @_oauth_client_secret = oauth_2credentials.oauth_client_secret unless
        oauth_2credentials.nil? || oauth_2credentials.oauth_client_secret.nil?
      @_oauth_token = oauth_2credentials.oauth_token unless
        oauth_2credentials.nil? || oauth_2credentials.oauth_token.nil?
      @_oauth_scopes = oauth_2credentials.oauth_scopes unless
        oauth_2credentials.nil? || oauth_2credentials.oauth_scopes.nil?
